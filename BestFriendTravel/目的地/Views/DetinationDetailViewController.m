//
//  DetinationDetailViewController.m
//  BestFriendTravel
//
...
@interface DetinationDetailViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation DetinationDetailViewController
...
-(void)loadData{
    //拼路径
    NSString *path=[NSString stringWithFormat:ROUTDETAIL_URL,_page,self.name];
    //转字符
